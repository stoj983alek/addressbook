		...
		<div class="large-12 columns">
			<table>
				...
				<tbody>
					...
					<tr>
						<td><a href='edit_contact.php'><?php echo $contact->first_name.' '.$contact->last_name; ?></a></td>
						...
						<td>
							<ul>
								...
								<li><?php echo $contact->city; ?> <?php echo $contact->district; ?> <?php echo $contact->zipcode; ?></li>
							</ul>
						</td>
					...
					<div class="row">
						...
						<div class="large-4 columns">
							<label>Phone Number
								<input name="phone" type="text" placeholder="Enter Phone Nunber" value="<?php echo $contact->phone; ?>">
							</label>
						</div>
						<div class="large-4 columns">
							<label>Contact Group
